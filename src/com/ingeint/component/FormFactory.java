...
import com.ingeint.forms.WQuickInputPO;
import com.ingeint.forms.WQuickInputProducts;
...
public class FormFactory extends CustomFormFactory {
	...
	@Override
	protected void initialize() {
		registerForm(WQuickInputProducts.class);
		registerForm(WQuickInputPO.class);
	}
